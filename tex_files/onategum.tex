...
\textbf{\class} & \textbf{Name:} & \makebox[2.5in][l]{ Martín Oñate Gutiérrez }\\
...
\begin{questions}
	...
	this transfer function to the unit step meets the requirements.
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.6]{./templates/images/block_16.png}
        ...
        \begin{equation*}
            G(s) =  \frac{1}{s^3 + 2.45s^2 + 2.37s + 1.58}
        \end{equation*}
