...
\textbf{\class} & \textbf{Name:} & \makebox[2.5in][l]{ Raphael Methens }\\
...
\begin{questions}
	...
	this transfer function to the unit step meets the requirements.
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.6]{./templates/images/block_9.png}
        ...
        \begin{equation*}
            G(s) =  \frac{1}{s^3 + 4.35s^2 + 18.94s + 6.53}
        \end{equation*}
