...
\textbf{\class} & \textbf{Name:} & \makebox[2.5in][l]{ Lukáš Hospodár }\\
...
\begin{questions}
	...
	this transfer function to the unit step meets the requirements.
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.6]{./templates/images/block_10.png}
        ...
        \begin{equation*}
            G(s) =  \frac{1}{s^3 + 3.75s^2 + 7.14s + 2.86}
        \end{equation*}
