...
\textbf{\class} & \textbf{Name:} & \makebox[2.5in][l]{ Tine Callewaert }\\
...
\begin{questions}
	...
	this transfer function to the unit step meets the requirements.
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.6]{./templates/images/block_3.png}
        ...
        \begin{equation*}
            G(s) =  \frac{1}{s^3 + 2.35s^2 + 1.64s + 1.09}
        \end{equation*}
