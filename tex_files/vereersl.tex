...
\textbf{\class} & \textbf{Name:} & \makebox[2.5in][l]{ Laura Vereerstraeten }\\
...
\begin{questions}
	...
	this transfer function to the unit step meets the requirements.
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.6]{./templates/images/block_15.png}
        ...
        \begin{equation*}
            G(s) =  \frac{1}{s^3 + 2.85s^2 + 4.61s + 2.19}
        \end{equation*}
