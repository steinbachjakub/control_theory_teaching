...
\textbf{\class} & \textbf{Name:} & \makebox[2.5in][l]{ Margot Dehaene }\\
...
\begin{questions}
	...
	this transfer function to the unit step meets the requirements.
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.6]{./templates/images/block_6.png}
        ...
        \begin{equation*}
            G(s) =  \frac{1}{s^3 + 3.35s^2 + 8.77s + 5.16}
        \end{equation*}
