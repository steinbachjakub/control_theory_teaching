...
\textbf{\class} & \textbf{Name:} & \makebox[2.5in][l]{ Pilar Genoveva Górriz Soriano }\\
...
\begin{questions}
        ...
        a frequency of $f=6 Hz$. Note that $\omega = 2\pi f$. In Simulink, check that the response of 
	this transfer function to the unit step meets the requirements.
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.6]{./templates/images/block_14.png}
        ...
        \begin{equation*}
            G(s) =  \frac{1}{s^3 + 3.75s^2 + 7.70s + 3.08}
        \end{equation*}
