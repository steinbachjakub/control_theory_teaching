...
\textbf{\class} & \textbf{Name:} & \makebox[2.5in][l]{ Gonzalo Marquez Aragon }\\
...
\begin{questions}
	...
	this transfer function to the unit step meets the requirements.
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.6]{./templates/images/block_2.png}
        ...
        \begin{equation*}
            G(s) =  \frac{1}{s^3 + 4.95s^2 + 22.03s + 6.67}
        \end{equation*}
