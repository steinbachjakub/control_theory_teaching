...
\textbf{\class} & \textbf{Name:} & \makebox[2.5in][l]{ Lucía Floría Canalís }\\
...
\begin{questions}
        ...
        a frequency of $f=4 Hz$. Note that $\omega = 2\pi f$. In Simulink, check that the response of 
	this transfer function to the unit step meets the requirements.
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.6]{./templates/images/block_5.png}
        ...
        \begin{equation*}
            G(s) =  \frac{1}{s^3 + 4.45s^2 + 13.08s + 4.22}
        \end{equation*}
