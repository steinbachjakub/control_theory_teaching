...
\textbf{\class} & \textbf{Name:} & \makebox[2.5in][l]{ Ioanna Stampouli }\\
...
\begin{questions}
	...
	this transfer function to the unit step meets the requirements.
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.6]{./templates/images/block_7.png}
        ...
        \begin{equation*}
            G(s) =  \frac{1}{s^3 + 3.95s^2 + 12.30s + 4.56}
        \end{equation*}
