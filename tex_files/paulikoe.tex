...
\textbf{\class} & \textbf{Name:} & \makebox[2.5in][l]{ Eliška Paulíková }\\
...
\begin{questions}
        ...
        a frequency of $f=2 Hz$. Note that $\omega = 2\pi f$. In Simulink, check that the response of 
	this transfer function to the unit step meets the requirements.
        ...
        \begin{equation*}
            G(s) =  \frac{1}{s^3 + 4.65s^2 + 15.88s + 5.12}
        \end{equation*}
