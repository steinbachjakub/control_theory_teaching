...
\textbf{\class} & \textbf{Name:} & \makebox[2.5in][l]{ Hana Josífková }\\
...
\begin{questions}
	...
	this transfer function to the unit step meets the requirements.
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.6]{./templates/images/block_8.png}
        ...
        \begin{equation*}
            G(s) =  \frac{1}{s^3 + 4.05s^2 + 15.02s + 5.18}
        \end{equation*}
