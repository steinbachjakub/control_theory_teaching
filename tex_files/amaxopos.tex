...
\textbf{\class} & \textbf{Name:} & \makebox[2.5in][l]{ Smaro Amaxopoulou }\\
...
\begin{questions}
        ...
        a frequency of $f=5 Hz$. Note that $\omega = 2\pi f$. In Simulink, check that the response of 
	this transfer function to the unit step meets the requirements.
        ...
        \begin{equation*}
            G(s) =  \frac{1}{s^3 + 3.05s^2 + 4.84s + 2.30}
        \end{equation*}
