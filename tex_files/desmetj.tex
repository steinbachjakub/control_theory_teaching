...
\textbf{\class} & \textbf{Name:} & \makebox[2.5in][l]{ Jolyne Desmet }\\
...
\begin{questions}
        ...
        a frequency of $f=3 Hz$. Note that $\omega = 2\pi f$. In Simulink, check that the response of 
	this transfer function to the unit step meets the requirements.
        ...
        \begin{equation*}
            G(s) =  \frac{1}{s^3 + 2.45s^2 + 2.33s + 1.37}
        \end{equation*}
