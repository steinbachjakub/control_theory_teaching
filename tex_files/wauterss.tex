...
\textbf{\class} & \textbf{Name:} & \makebox[2.5in][l]{ Sara Patricia Wauters }\\
...
\begin{questions}
        ...
        a frequency of $f=10 Hz$. Note that $\omega = 2\pi f$. In Simulink, check that the response of 
	this transfer function to the unit step meets the requirements.
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.6]{./templates/images/block_13.png}
        ...
        \begin{equation*}
            G(s) =  \frac{1}{s^3 + 4.55s^2 + 18.99s + 6.13}
        \end{equation*}
